! Simulation of epidemics based on continuous time region-retricted GD-ILMs under SEIR compartmental framework
! Author: Md Mahsin (md.mahsin@ucalgary.ca)
! Date: September 26, 2019
!How to run it: gfortran nmahsin-cont-SEIR.f90
!It generates 9 columns: (1) ID; (2) Removal time;(3) Infectious period;
! (4) Infection time; (5) Latent period; (6) Exposed time; 
! (7) LGA's number; (8) Population size of each DA; (9) Spatial random effects.
!To discretize this continuous epidemics, we need only the infection time i.e.,  column (4)
...
open(232,  file = "/Users/mahsin/Documents/OneDriveM/Research/SEIR/SEIR_sim1.txt" )
...
open(5556, file = "/Users/mahsin/Documents/OneDriveM/Research/SEIR/phi_seir.txt")
do m = 1 , n
read(5556,*) phi(m)
end do
close(5556)
